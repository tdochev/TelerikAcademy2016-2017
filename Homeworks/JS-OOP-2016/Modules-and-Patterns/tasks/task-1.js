...
function solve() {
    ...
    const validator = {
        validateEmptyPresentation: function(presentations) {
    ...
    class Course {
        ...
        set presentations(value) {
            validator.validateEmptyPresentation(value);
            value.forEach(function(p) {
                validator.validateTitle(p);
            });
...
let test = solve();
let da = test.init("Title", ['test1', 'test2']);
da.addStudent("Peshov Peshov");
console.log(da);
